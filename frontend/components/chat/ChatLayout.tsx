      ...
      <div className="flex min-h-screen bg-background">
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          <button
            ...
            className="bg-red-400 hover:bg-red-500 text-white px-4 py-2 rounded-lg transition-colors font-medium cursor-pointer hover:shadow-md transform hover:scale-105 duration-200"
          >
            Clear Chat
          </button>
        </div>
